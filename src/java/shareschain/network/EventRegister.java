...
import shareschain.network.EventListener.EventRegistration;
 ...
 * issue an EventWait before the time interval specified by shareschain.apiEventTimeout
 ...
 * specified by shareschain.apiMaxEventUsers has been reached or if the maximum number
 * of user registrations specified by shareschain.api.MaxUserEventRegistrations has been
 * reached.
 * <p>
 * Request parameters:
 * <ul>
...
public class EventRegister extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        if (params == null) {
            ...
            //
            EventListener.nodeEvents.forEach(event -> events.add(new EventRegistration(event, 0)));
            ...
            for (String param : params) {
                ...
                switch (parts[0]) {
                    case "Block":
                        ...
                        break;
                    case "Node":
                        eventList = EventListener.nodeEvents;
                        break;
                    case "Transaction":
