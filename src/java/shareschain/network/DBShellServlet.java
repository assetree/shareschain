...
public final class DBShellServlet extends HttpServlet {
    ...
    private static final String header =
            "<!DOCTYPE html>\n" +
                    ...
                    "<head>\n" +
                    "    <meta charset=\"UTF-8\"/>\n" +
                    "    <title>Shareschain H2 Database Shell</title>\n" +
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in shareschain.properties. " +
                    "Please set shareschain.adminPassword or disable the password protection with shareschain.disableAdminPassword";
