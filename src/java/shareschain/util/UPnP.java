...
public class UPnP {
    ...
    public static synchronized void addPort(int port) {
        ...
        try {
            if (gateway.addPortMapping(port, port, localAddress.getHostAddress(), "TCP",
                                       Shareschain.APPLICATION + " " + Shareschain.VERSION)) {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Shareschain.getIntProperty("shareschain.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Shareschain.getIntProperty("shareschain.upnpDiscoverTimeout", discover.getTimeout()));
